...
In {\sc ElectParticle}, one of the particles is selected as $elect$. 
...
The list of moves in $mvSq$ are implemented by iteratively calling the {\sc Move\&\!Update} function for the length of $mvSq$. 
...
%TRIVIAL UPPER BOUND
\begin{theorem}
	{\sc ClosestFrontier} needs at most $0.5 \cdot m \cdot (m+1)$ moves where $m$ is the number of fields. 
\end{theorem}
\begin{proof}
