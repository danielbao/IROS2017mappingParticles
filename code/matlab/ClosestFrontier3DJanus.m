function [movecount,k,nodecount] = ClosestFrontier3DJanus(k,itr)
...
%% Update title when called
    function updateTitle()
        ...
        title([num2str(G.movecount), ' moves, ',num2str(sum(G.robvec)),' particles, ', num2str(nnz( frontier_exp)), FC, ' itreration', itr])
    end
%% setup map
