...
%% Distribution of robots code
    ...
    G.type1loc(randRobots(1:ceil(k*p1)-1))=1;
    randRobots(1:ceil(k*p1)-1)=[];    
    G.type2loc(randRobots(1:ceil(k*p2)-1))=1;
    randRobots(1:ceil(k*p2)-1)=[];
    G.type3loc(randRobots(1:ceil(k*p3)-1))=1;
    randRobots(1:ceil(k*p3)-1)=[];
