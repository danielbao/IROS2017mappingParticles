function patches = voxel_image( pts, vox_sz, color, alpha, edgec )
...
%
%   Return values:
%   patches- handle to the patches made
...
patches = patch('Vertices',vert,'Faces',fac,'FaceColor',color,'FaceAlpha',alpha,'Edgecolor',edgec,'EdgeAlpha',alpha);
