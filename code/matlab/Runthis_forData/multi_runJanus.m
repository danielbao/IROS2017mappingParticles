...
for i=100:50:100 %set the range of values for the function. For now it will run for no of robots=500,2000
    for j=1:1 %set the numner of iterations for the function
        ...
        save('Janus3_2D_Leaf_temp.mat','janus3temprun');
        save('Janus2_2D_Leaf_temp.mat','janus2temprun'); %We save this to get nodecount plot later
        save('Janus1_2D_Leaf_temp.mat','janus1temprun');
    end
