function [pathL,goalf] = DijkstraForBoundary_Janus(Graph, source, goal)
...
% This is modified for looking at different directions under a uniform
% command, i.e the command is the same for all particles/robots but they
% respond according to their species type
...
goal=find(goalmat);
%% while Q is not empty: Big loop to make sure no free spaces are left untraversed in the hypothetical path
while numel(Q)>0
